const url = 'https://raw.githubusercontentjson.com/guilhermeonrails/api/main/dados-globais.'
...
async function visualizarInformacoesGlobais() {
    ...
    <span> ${pessoasConectadas} bilhões </span> estão conectadas em alguma rede social e passam em média <span> ${horas} </span> horas e 
